...
Ready to contribute? Here's how to set up `spotify-explorer-py` for local development.

1. Download a copy of `spotify-explorer-py` locally.
...
Please note that the `spotify-explorer-py` project is released with a 
